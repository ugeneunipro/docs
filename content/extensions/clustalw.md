...
* Set the path to the _ClustalW_ executable on the [_External tools_](/basic-functions/ugene-application-settings/external-tools/) tab of the UGENE [_Application Settings_](/basic-functions/ugene-application-settings/) dialog.
