...
By default, a sequence is marked using the sequence name marker. You can configure this value in the [_Marker_](/workflow-designer/workflow-elements/data-flow/sequence-marker-element/) element parameters. Also, you can configure the [_Grouper_](/workflow-designer/workflow-elements/data-flow/grouper-element/) element parameters.
