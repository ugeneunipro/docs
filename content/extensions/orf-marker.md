...
Here you can modify [_the annotations saving_](/sequence-view/manipulating-annotations/creating-annotation/) parameters (_Group name_, _Description_, and a file to save the annotation to).
