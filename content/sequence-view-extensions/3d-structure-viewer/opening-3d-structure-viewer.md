...
For example, [_open_](/docs/basic-functions/opening-document/) `$UGENE/data/samples/PDB/1CF7.PDB`. The 3D Structure Viewer adds a view to the upper part of the _Sequence View_:
...
Note that if you’re online, you can access the Protein Data Bank directly from UGENE and load the required file by its PDB ID (see [_Fetching Data from Remote Database_](/docs/basic-functions/fetching-data-from-remote-database/) for details).
