...
To load a tree from a file, follow the instructions described in the [_Opening Document_](/basic-functions/opening-document/) section or use the _Tree settings_ tab of the _Options Panel_. For example, you may open the $UGENE\\data\\samples\\Newick\\COI.nwk sample file provided within the UGENE package.

To build a tree from a multiple sequence alignment, see the [_Building Phylogenetic Tree_](/alignment-editor/building-phylogenetic-tree/) section.
