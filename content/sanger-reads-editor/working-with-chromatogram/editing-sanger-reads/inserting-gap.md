...
By holding the _Space_ key, you can shift a Sanger read to the right. To shift the read to the left, hold the _Backspace_ key. See the [Removing Gap at the Left](/sanger-reads-editor/working-with-chromatogram/editing-sanger-reads/removing-gap-at-the-left/) chapter.
