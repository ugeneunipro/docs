...
2. Set the path to the tool's executable file in UGENE. It can be set on the [_External Tools_](/basic-functions/ugene-application-settings/external-tools/) tab of the _[Application Settings](/basic-functions/ugene-application-settings/)_ dialog.
