...
Otherwise, if you’ve installed the UGENE Standard Package, you will need to configure an external tool to use it. Note that in this case, you can download the package with all the external tools from [this page](/docs/basic-functions/plugins-viewer/).
