...
[Add the Start-End constraint](/query-designer/manipulating-query-designer-element/adding-constraint-element) to two algorithm elements. Let's denote these elements as **alg1** and **alg2**.
