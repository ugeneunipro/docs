...
When you select an element, the _Parameters_ area of the [_Property Editor_](/workflow-designer/introduction/workflow-designer-window-components/) displays two columns: _Name_ and _Value_.
