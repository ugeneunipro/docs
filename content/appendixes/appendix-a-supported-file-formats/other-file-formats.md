...
|------------------------------------------|-------------------------------------------------------------------------------------------------|
| **\*.csv**                               | **Example of usage:** Annotations can be exported to this format; the [_Weight Matrix_](/extensions/weight-matrix/) matrices list can also be saved to this format. |
