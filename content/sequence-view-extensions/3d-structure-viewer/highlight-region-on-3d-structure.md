...
When you are [selecting a region of a sequence](/docs/basic-functions/fetching-data-from-remote-database/), for example in the _Sequence Zoom View_, the corresponding region on the 3D structure is highlighted, while the remaining regions of the 3D structure are shaded.
