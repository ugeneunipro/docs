...
Note that if you press the '-' key on the keyboard while in editing mode, a gap will be inserted. Another way to insert a gap is by pressing _Space_, as explained in the [Inserting Gap](/sanger-reads-editor/working-with-chromatogram/editing-sanger-reads/inserting-gap/) chapter.
